...
# URLs: http://localhost:8000/dashboard.html | /patient.html | /doctor.html
...
echo "  patient:   http://localhost:8000/patient.html"
echo "  doctor:    http://localhost:8000/doctor.html"
